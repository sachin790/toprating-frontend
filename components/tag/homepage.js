...
export default class HomePage extends Component {
  ...
  cancelHighlightItem = item => {
    this.setState(
      previousState => ({
        [item]: false
      }),
      () => {
        this.RemoveFilterTag(this.props.tagie);
      }
    );
  };
        ...
        <div className="home-page">
          ...
          <React.Fragment>
            <div className={"feed"}>
              <ul className="feed-card">
                <li className="feed-card-filter">Filter</li>
                {this.props.otherTags.map((item, index) => {
                  return (
                    <li
                      key={index}
                      className={
                        this.state[item]
                          ? "feed-card-item feed-card-item-selected"
                          : "feed-card-item"
                      }
                    >
                      <span
                        ...
                        onClick={() => this.highlightItem(item)}
                      >
                        {item}
                      </span>
                      <span
                        ...
                        onClick={() => this.cancelHighlightItem(item)}
                      >
                        &times;
                      </span>
                    </li>
          ...
          <style jsx>
            {`
              ...
              .feed-card-item-selected:hover .cancel-highlight {
                visibility: visible;
              }
