...
const OptionViewLandingPage = ({ OptionDetails }) => {
  const newQuestionString = RemoveSpacesAddHyphen(OptionDetails.question);
  return (
    <div className="landing">
      <div className="landing-tag" />
      <div className="landing-question">
        {OptionDetails ? OptionDetails.question + "?" : "loading..."}
      </div>
...
export default OptionViewLandingPage;
