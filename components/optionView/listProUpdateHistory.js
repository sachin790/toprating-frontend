...
function UpdateOptionItem({ question, option, description, title, createdAt }) {
...
export default function ListUpdatedProView({ question, updated }) {
  //   const { updated } = props;
  if (updated.length === 0)
