...
import HomePage from "../components/tag/homepage";
import Axios from "axios";
import TagLandingPage from "../components/tag/TagLandingPage";
import OtherTags from "../components/tag/otherTags";
...
export default class extends React.Component {
  static async getInitialProps({ query: { tagie } }) {
    const tagResponse = await GetTopicsByTag(tagie);
    const otherTagResponse = await GetOtherTags(tagie);
  ...
  render() {
    ...
    return (
      <Layout
        ...
        {...this.state}
      >
        <TagLandingPage {...this.state} tag={this.props.tagie} />
        <OtherTags otherTags={this.props.otherTags} />
