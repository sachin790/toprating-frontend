...
import ListUpdatedOptionView from "../components/ListOptionUpdateHistory";
const TopicLandingPage = ({
  ...
  const _tag = tag ? flattenArray(tag) : [];
  return (
...
export default class extends Component {
  static async getInitialProps({ query: { option } }) {
    const res = await GetOptionUpdateHistory(option);
