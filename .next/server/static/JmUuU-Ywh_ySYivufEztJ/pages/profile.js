...
// EXTERNAL MODULE: ./components/profilePageBody.js
var profilePageBody = __webpack_require__("NcQY");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return profile_default; });
...
function ProfileHeaderStat(props) {
  ...
  }, props.statCount), external_react_default.a.createElement("div", {
    className: "jsx-1413446998" + " " + "profile-page-header-user-stat-text"
  }, props.statText), external_react_default.a.createElement(style_default.a, {
    id: "1413446998"
...
var profile_ProfilePageHeader =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(ProfilePageHeader, _Component);
  ...
  function ProfilePageHeader() {
    ...
    Object(classCallCheck["a" /* default */])(this, ProfilePageHeader);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(ProfilePageHeader)).call.apply(_getPrototypeOf2, [this].concat(args)));
      ...
      if (_data) {
        Object(apiRequests["x" /* GET_USER_KARMA */])(_data._id).then(function (axiosRes) {
          ...
          _this.setState({
            ...
            _this.props.getKarm(axiosRes.data.karma);
          });
        }).catch(function (err) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleUpdateProfileSubmit", function (e) {
      var _id = _this.props._id;
      e.preventDefault();
      var displayName = _this.displayName.value;
      var email = _this.email.value;
      var userName = _this.username.value;
      Object(apiRequests["sb" /* updateUser */])(_id, email, displayName, userName).then(function (result) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "toggleUpdateProfile", function () {
      _this.setState(function (previousState) {
        return {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "onInputChange", function (e) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleUpdateImage", function (e) {
      e.preventDefault();
      var file = _this.state.file; //image buffer to be uploaded

      var _id = _this.props._id;

      var progress = function progress(snapshot) {
        //Progress function here
        var _progress = Math.round(snapshot.bytesTransferred / snapshot.totalBytes * 100);
      ...
      var complete = function complete() {
        storage.ref("images").child(file.name).getDownloadURL().then(function (url) {
          // console.log(url);
          Object(apiRequests["nb" /* addAvatar */])(url, _id).then(function (response) {
      ...
      var uploadTask = storage.ref("/images/".concat(file.name)).put(file);
  ...
  Object(createClass["a" /* default */])(ProfilePageHeader, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.fetchUserKarma();
    }
    ...
    value: function render() {
      ...
      var image = this.props.image ? this.props.image : "/static/gravatar.png";
      var _this$state = this.state,
          ...
          profileModal = _this$state.profileModal;

      var _date = new Date(createdAt);

      var date = Object(dateConversion["a" /* default */])(now_default()(), _date);
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("div", {
      ...
      }, external_react_default.a.createElement(ProfileHeaderStat, {
        statCount: this.props.recHistory ? this.props.recHistory.length : 0,
        statText: "RECS"
      }), external_react_default.a.createElement(ProfileHeaderStat, {
      ...
      }, this.props.username || "@username"), external_react_default.a.createElement("div", {
        className: "jsx-3814191755" + " " + "profile-page-header-edit-links"
        ...
        className: "jsx-3814191755"
      }, "Update Profile"), external_react_default.a.createElement("span", {
        className: "jsx-3814191755" + " " + "link-seperator"
      }), external_react_default.a.createElement("a", {
        style: {
          textTransform: "none"
        },
        ...
        onClick: this.toggle,
        className: "jsx-3814191755" + " " + ""
      }, "Update image")), external_react_default.a.createElement("div", {
        className: "jsx-3814191755" + " " + "profile-page-header-bio"
      }, external_react_default.a.createElement("div", {
        className: "jsx-3814191755" + " " + "profile-page-header-bio-content"
      }, "I\u2019ve been a user since ", date)))))), external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_react_bootstrap_["Modal"], {
        style: {
          marginTop: "40px"
        },
        show: modal,
        ...
        closeButton: true
      }, external_react_default.a.createElement(external_react_bootstrap_["Modal"].Title, null, "Update Avatar")), external_react_default.a.createElement(external_react_bootstrap_["Modal"].Body, null, external_react_default.a.createElement("form", {
        className: "jsx-3814191755"
      }, external_react_default.a.createElement("label", {
        className: "jsx-3814191755" + " " + ((imageAdded ? "fileContainer added" : "fileContainer") || "")
      }, external_react_default.a.createElement("em", {
        className: "jsx-3814191755" + " " + "choose"
      }, imageAdded ? "Image Attached" : "Choose an Image"), external_react_default.a.createElement("input", {
        type: "file",
        name: "myImage",
        onChange: function onChange(e) {
          return _this2.onInputChange(e);
        },
        className: "jsx-3814191755" + " " + "custom-file-input"
      })), external_react_default.a.createElement("progress", {
        value: progressLevel,
        max: 100,
        className: "jsx-3814191755" + " " + "progress-style"
      }), external_react_default.a.createElement("span", {
        className: "jsx-3814191755" + " " + "level"
      }, progressLevel, " %"))), external_react_default.a.createElement(external_react_bootstrap_["Modal"].Footer, null, external_react_default.a.createElement(external_react_bootstrap_["Button"], {
        variant: "secondary",
        onClick: this.toggle
        ...
        disabled: !file // onClick={this.toggle}
        ...
        closeButton: true
      }, external_react_default.a.createElement(external_react_bootstrap_["Modal"].Title, null, "Update Profile")), external_react_default.a.createElement(external_react_bootstrap_["Modal"].Body, null, external_react_default.a.createElement("form", {
        className: "jsx-3814191755"
      }, external_react_default.a.createElement("div", {
        className: "jsx-3814191755" + " " + "update-div"
        ...
        ref: function ref(input) {
          return _this2.displayName = input;
        },
        className: "jsx-3814191755"
...
var profile_ReturnToHome = function ReturnToHome() {
...
/*#__PURE__*/
function (_Component2) {
  Object(inherits["a" /* default */])(_default, _Component2);
  ...
  function _default() {
    ...
    _this3 = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf3 = Object(getPrototypeOf["a" /* default */])(_default)).call.apply(_getPrototypeOf3, [this].concat(args)));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this3), "state", {
      userData: "",
      id: "",
      data: _this3.props.data.data,
      imageUrl: "",
      recHistory: [],
      questionsAdded: []
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this3), "getQuestionsAddedByUser", function (id) {
      Object(apiRequests["Q" /* GetQuestionsAddedByUser */])(id).then(function (response) {
        _this3.setState({
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this3), "getUserRecHistory", function (id) {
      Object(apiRequests["R" /* GetRecHistory */])(id).then(function (result) {
        _this3.setState({
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this3), "getKarm", function (value) {
      _this3.setState({
        karma: value
      });
    });
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                user_data = JSON.parse(localStorage.getItem("user_details"));
                ...
                return _context.abrupt("return", profile_ReturnToHome());
              ...
              case 3:
                ...
                new promise_default.a(function (resolve, reject) {
                  ...
                  external_axios_default.a.get("".concat(apiRequests["g" /* Auth */], "/user/data/").concat(result)).then(function (data) {
                  ...
                  return console.log(error, "is here");
                });
