...
function (_React$Component) {
  ...
  function Ask() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(_this), "handleSubmit", function (e) {
      ...
      Object(_apiRequests_apiRequests__WEBPACK_IMPORTED_MODULE_16__[/* ManageTag */ "U"])(questionId, tag, question).then(function (result) {
        _this.setState({
          showSnackbar: true,
          message: "Tag Added"
        }); //Synchronous
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                id = _ref4.query.id;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_13___default()(_apiRequests_apiRequests__WEBPACK_IMPORTED_MODULE_16__[/* _GET_TOPICS */ "kb"]);
