...
function (_React$Component) {
  ...
  function QuestionCard() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "getQuestionOptions", function (question) {
      Object(apiRequests["X" /* SPECIFIC_QUESTION_OPTIONS */])(question).then(function (options) {
        _this.setState({
          option: options.data
        });
      }).catch(function (err) {
...
function (_Component) {
  ...
  function HomePage() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSortBy", function (period) {
      //Fetch items here
      Object(apiRequests["cb" /* SortRecommendations */])(period).then(function (result) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSortQuestions", function (period) {
      Object(apiRequests["bb" /* SortQuestions */])(period).then(function (result) {
        _this.setState({
          topics: result.data
        }); // console.log(result.data);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                ...
                _context.next = 12;
                return external_axios_default()(apiRequests["jb" /* _GET_RECS */]);

              case 12:
                recResponse = _context.sent;
                _context.next = 15;
                return external_axios_default()(apiRequests["ib" /* _GET_QUESTION_ACTIVITY */]);
...
function (_Component) {
  ...
  function TopicViewPopupModal() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(_this), "handleSubmit", function () {
      ...
      Object(_apiRequests_apiRequests__WEBPACK_IMPORTED_MODULE_10__[/* user_recommendation */ "rb"])(_data).then(function (result) {
