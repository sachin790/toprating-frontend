...
function (_Component) {
  ...
  function _default() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleUpdatePro", function () {
      ...
      Object(apiRequests["gb" /* UpdatePro */])(proId, user._id, proTitle.replace("%", " percent"), proDescription.replace("%", " percent"), option, OptionDetails._id, OptionDetails.question).then(function (result) {
        alert("updated");
        ...
        Object(apiRequests["Z" /* SaveProHistory */])(data).then(function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleConUpdate", function () {
      ...
      Object(apiRequests["eb" /* UpdateCon */])(conId, user._id, conTitle.replace("%", " percent"), conDescription.replace("%", " percent"), option, OptionDetails._id, OptionDetails.question).then(function (result) {
        alert("updated");
        ...
        Object(apiRequests["Y" /* SaveConHistory */])(data).then(function (result) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return external_axios_default()(apiRequests["kb" /* _GET_TOPICS */]);
