...
function (_Component) {
  ...
  function OptionList() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSpam", function (option) {
      ...
      Object(apiRequests["V" /* MarkOptionAsSpam */])(_data).then(function (response) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSaveUpdatedOption", function () {
      ...
      Object(apiRequests["fb" /* UpdateOption */])(optionId, user._id, updatedOption, updatedOptionLink).then(function (result) {
        ...
        Object(apiRequests["ab" /* SaveUpdateHistory */])(_saveUpdateHistory).then(function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleProUpdate", function () {
      ...
      Object(apiRequests["gb" /* UpdatePro */])(proId, user._id, proTitle.replace("%", " percent"), proDescription.replace("%", " percent"), option, optionId, question).then(function (result) {
        alert("updated");
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleConUpdate", function () {
      ...
      Object(apiRequests["eb" /* UpdateCon */])(conId, user._id, conTitle.replace("%", " percent"), conDescription.replace("%", " percent"), option, optionId, question).then(function (result) {
        alert("updated");
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_["Fragment"], null, this.props.data.map(function (item) {
        ...
        if (item.mediaUrl.length < 2) {
          return external_react_default.a.createElement("div", {
          ...
          }, like))), external_react_default.a.createElement("button", {
            onClick: function onClick() {
              if (!JSON.parse(localStorage.getItem("user_details"))) {
                _this2.setState({
                  UserLoggedIn: false,
            ...
            className: style_default.a.dynamic([["1464024445", [profileImageUrl]]]) + " " + "recommend-text numie"
          }, dislike))))));
        }
  ...
  Object(createClass["a" /* default */])(_default, [{
    ...
    value: function render() {
      ...
      , {
        ...
        url: question
      }), optionConsidered !== 0 && questionRejected === false && external_react_default.a.createElement(optionList_OptionList, this.state), questionRejected === true && external_react_default.a.createElement(reactionBanner, null)), external_react_default.a.createElement("div", {
    ...
    value: function () {
      ...
      regenerator_default.a.mark(function _callee(_ref) {
        var name, question, res, relatedTopicResponse, questionUpdatedAt, questionNumOfRecs, recsActivity, rejectedResponse, response;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
