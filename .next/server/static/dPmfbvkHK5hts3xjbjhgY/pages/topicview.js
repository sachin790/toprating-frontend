...
function (_React$Component) {
  ...
  Object(createClass["a" /* default */])(CustomTab, [{
    ...
    value: function getOptionPros(id) {
      ...
      //Do something here
      Object(apiRequests["G" /* GetOptionPros */])(id).then(function (result) {
    ...
    value: function getOptionCons(id) {
      ...
      //Do something here
      Object(apiRequests["F" /* GetOptionCons */])(id).then(function (result) {
        // console.log(result.data);
        _this3.setState({
          cons: result.data
        });
...
function (_Component) {
  ...
  function OptionList() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleDislike", function () {
      var user = JSON.parse(localStorage.getItem("user_details"));
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSpam", function (option) {
      ...
      Object(apiRequests["X" /* MarkOptionAsSpam */])(_data).then(function (response) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSaveUpdatedOption", function () {
      ...
      Object(apiRequests["hb" /* UpdateOption */])(optionId, user._id, updatedOption, updatedOptionLink).then(function (result) {
        ...
        Object(apiRequests["cb" /* SaveUpdateHistory */])(_saveUpdateHistory).then(function () {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleProUpdate", function () {
      ...
      Object(apiRequests["ib" /* UpdatePro */])(proId, user._id, proTitle.replace("%", " percent"), proDescription.replace("%", " percent"), option, optionId, question).then(function (result) {
        alert("updated");
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleConUpdate", function () {
      ...
      Object(apiRequests["gb" /* UpdateCon */])(conId, user._id, conTitle.replace("%", " percent"), conDescription.replace("%", " percent"), option, optionId, question).then(function (result) {
        alert("updated");
                    ...
                    return regenerator_default.a.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return Object(apiRequests["V" /* GetUserReactionToLikeOption */])(res, _this2.state.data);

                          case 2:
                            LikeColor = _context.sent;
                            _context.next = 5;
                            return Object(apiRequests["U" /* GetUserReactionToDisLikeOption */])(res, _this2.state.data);
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_["Fragment"], null, this.props.data.map(function (item) {
        ...
        if (item.mediaUrl.length < 2) {
          ...
          }, _this3.state.LikeNumber[item.option] - _this3.state.DisLikeNumber[item.option])), external_react_default.a.createElement(link_default.a, {
            prefetch: true,
          ...
          }, _this3.state.LikeNumber[item.option]))), external_react_default.a.createElement("button", {
            onClick: function onClick() {
              if (!JSON.parse(localStorage.getItem("user_details"))) {
                _this3.setState({
                  UserLoggedIn: false,
...
var topicview_socket = external_socket_io_client_default()(config["c" /* default */]);
...
function (_Component) {
  ...
  function _default() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "userId",
    /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 13:
                ...
                _context2.next = 16;
                return Object(apiRequests["P" /* GetQuestionUpdatedAt */])(question);

              case 16:
                questionUpdatedAt = _context2.sent;
                _context2.next = 19;
                return Object(apiRequests["M" /* GetQuestionNumOfRecs */])(question);

              case 19:
                questionNumOfRecs = _context2.sent;
                _context2.next = 22;
                return Object(apiRequests["S" /* GetTopicRecommendations */])(question);
