...
// CONCATENATED MODULE: ./components/tag/IrecommendCard.js
...
/* harmony default export */ var tag_IrecommendCard = (IrecommendCard_IrecommendCard);
// CONCATENATED MODULE: ./components/tag/iRecommend.js
...
// CONCATENATED MODULE: ./components/tag/QuestionCard.js
...
function (_React$Component) {
  ...
  function QuestionCard() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "getQuestionNumOfRecs", function (question) {
      Object(apiRequests["M" /* GetQuestionNumOfRecs */])(question).then(function (axiosResponse) {
        _this.setState({
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "getQuestionOptions", function (question) {
      Object(apiRequests["Z" /* SPECIFIC_QUESTION_OPTIONS */])(question).then(function (options) {
        _this.setState({
          option: options.data
        });
      }).catch(function (err) {
  ...
  Object(createClass["a" /* default */])(QuestionCard, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement(tag_IrecommendCard, Object(esm_extends["a" /* default */])({
...
/* harmony default export */ var tag_QuestionCard = (QuestionCard_QuestionCard);
...
// CONCATENATED MODULE: ./components/tag/recComponent.js
...
function (_React$Component) {
  ...
  function RecComponent() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "getQuestionNumOfRecs", function (option) {
      Object(apiRequests["M" /* GetQuestionNumOfRecs */])(option).then(function (axiosResponse) {
...
// CONCATENATED MODULE: ./components/tag/IRecommend2.js
...
/* harmony default export */ var tag_IRecommend2 = (IRecommend2_IRecommend2);
// CONCATENATED MODULE: ./components/tag/helpRecommendCard.js
...
function (_Component) {
  ...
  function HelpRecommendCard() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleNextQuestion", function () {
      var question = _this.question.innerText.replace("?", "");

      Object(apiRequests["E" /* GetNextQuestion */])(question).then(function (result) {
        _this.setState({
          data: result.data
        });
      }).then(function () {
        _this.props.holdQuestion(_this.question.innerText.replace("?", ""));
      }).catch(function (err) {
  ...
  Object(createClass["a" /* default */])(HelpRecommendCard, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        className: "jsx-86509230" + " " + "card-list-seperator"
      }), external_react_default.a.createElement("div", {
        className: "jsx-86509230" + " " + "card-list-footer center"
      }, external_react_default.a.createElement("div", {
        className: "jsx-86509230" + " " + "help-recommend-holder"
      }, external_react_default.a.createElement("span", {
        className: "jsx-86509230" + " " + "help-recommend-call-to-action"
      }, external_react_default.a.createElement(external_react_bootstrap_["OverlayTrigger"], {
        key: "top",
        placement: "top",
        overlay: external_react_default.a.createElement(external_react_bootstrap_["Tooltip"], null, "Recommend or add the options you think are the best")
        ...
        className: "jsx-86509230"
      }, external_react_default.a.createElement(tag_IRecommend2, {
        showIrecommendCard: this.props.showIrecommendCard
      })))))), external_react_default.a.createElement(style_default.a, {
        id: "86509230"
      }, [".card-list-answer-subtitle.jsx-86509230{line-height:4px;margin-top:18px;color:#58647b !important;font-family:Cabin;font-weight:600;font-size:16px;}", ".help-recommend-holder.jsx-86509230{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}", ".button-skip.jsx-86509230{position:relative;top:-15px;font-size:14px;font-weight:600;text-transform:uppercase;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;float:right;height:36px;background-color:#e6e8eb;border-radius:9px;color:#8d959c;outline:0;border:0;padding:0 18px;white-space:nowrap;cursor:pointer;}", ".help-recommend-call-to-action.jsx-86509230{padding:5px;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;text-align:center;cursor:pointer;color:#fff;}", ".card-list-answer-title.jsx-86509230 a.jsx-86509230{-webkit-text-decoration:none;text-decoration:none;font-family:Cabin;font-size:inherit;color:#000 !important;line-height:1.2;text-align:center;}", ".card-list-answer-title.jsx-86509230{margin:auto;font-size:21px;font-weight:600;line-height:14px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;min-height:102px;position:relative;margin:0;padding:6px 0;width:100%;text-align:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}", ".card-list-item.jsx-86509230{overflow:hidden;background:#fdfdfd;margin-bottom:5px;padding:18px;border:1px solid #e6e8eb;border-radius:2px;max-height:300px;min-height:200px;border-radius:1px;}", "@media (max-width:767px){.card-list-answer-title.jsx-86509230{font-size:18px;line-height:30px;}.card-list-item.jsx-86509230{margin:0 0 30px;padding:12px;}}"]));
    }
  }]);
...
// CONCATENATED MODULE: ./components/tag/topbarComponent.js
...
// CONCATENATED MODULE: ./components/tag/homepage.js
...
function (_Component) {
  ...
  function HomePage() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSortBy", function (period) {
      //Fetch items here
      Object(apiRequests["eb" /* SortRecommendations */])(period).then(function (result) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSortQuestions", function (period) {
      Object(apiRequests["db" /* SortQuestions */])(period).then(function (result) {
        _this.setState({
          topics: result.data
        }); // console.log(result.data);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "FilterTag", function (filter) {
      Object(apiRequests["o" /* FilterTopicsByTag */])(filter).then(function (result) {
        _this.setState({
          tags: result.data
        });
      }).catch(function (error) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "RemoveFilterTag", function (tag) {
      Object(apiRequests["T" /* GetTopicsByTag */])(tag).then(function (result) {
        _this.setState({
          tags: result.data
        });
      }).catch(function (error) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "highlightItem", function (item) {
      _this.setState(function (previousState) {
        return Object(defineProperty["a" /* default */])({}, item, true);
      }, function () {
        _this.FilterTag(item);
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "cancelHighlightItem", function (item) {
      _this.setState(function (previousState) {
        return Object(defineProperty["a" /* default */])({}, item, false);
      }, function () {
        _this.RemoveFilterTag(_this.props.tagie);
      });
    });
  ...
  Object(createClass["a" /* default */])(HomePage, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + "home-page"
      }, external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + "home-page-view"
      }, external_react_default.a.createElement("div", {
        style: {
          background: "transparent",
          boxShadow: "none"
        },
        className: "jsx-1209067736" + " " + "nav-header scrollable show-mobile"
      }), external_react_default.a.createElement("div", {
        className: "jsx-1209067736"
      }, external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + "page-content"
      }, external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + "new-feed-container"
      }, external_react_default.a.createElement(feedCard["a" /* default */], this.props)), external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + "home-page-feed card-list"
      }, external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + "rec-card-list"
      }, showRec && external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + "rec-card-list-header"
      ...
      }), external_react_default.a.createElement(external_react_default.a.Fragment, null, tags.map(function (item) {
        ...
        className: "jsx-1209067736" + " " + "feed"
      }, external_react_default.a.createElement("ul", {
        className: "jsx-1209067736" + " " + "feed-card"
      }, external_react_default.a.createElement("li", {
        className: "jsx-1209067736" + " " + "feed-card-filter"
      }, "Filter"), this.props.otherTags.map(function (item, index) {
        return external_react_default.a.createElement("li", {
          key: index,
          className: "jsx-1209067736" + " " + ((_this2.state[item] ? "feed-card-item feed-card-item-selected" : "feed-card-item") || "")
        }, external_react_default.a.createElement("span", {
          style: {
          ...
          className: "jsx-1209067736"
        }, item), external_react_default.a.createElement("span", {
          style: {
            float: "right",
            fontSize: "22px"
          },
          onClick: function onClick() {
            return _this2.cancelHighlightItem(item);
          },
          className: "jsx-1209067736" + " " + "cancel-highlight"
        }, "\xD7"));
      })))), showIrecommendCard && external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + ((showIrecommendCard ? "showOverlay" : "overlay") || "")
      }, external_react_default.a.createElement("section", {
        className: "jsx-1209067736" + " " + "section-theme section-theme-i-rec-1"
      }, external_react_default.a.createElement(tag_IrecommendCard, {
      ...
      external_react_default.a.createElement("div", {
        className: "jsx-1209067736" + " " + ((showAddRecommendation ? "showOverlayie" : "overlay") || "")
      }, external_react_default.a.createElement("section", {
        className: "jsx-1209067736" + " " + "section-theme section-theme-i-rec"
      }, external_react_default.a.createElement(topicviewPopupModal["a" /* default */], {
        question: selectedOptionQuestion,
        option: selectedOption,
        optionImage: selectedOptionImage,
        ...
        className: "jsx-1209067736" + " " + "close-popup-iconie"
      }, external_react_default.a.createElement("span", {
        style: {
          position: "relative",
          top: "-2px"
        ...
        id: "1209067736"
      }, [".overlay.jsx-1209067736{height:100%;width:0;position:fixed;z-index:6000;top:0;left:0;background-color:rgb(0,0,0);background-color:rgba(0,0,0,0.5);overflow-x:hidden;-webkit-transition:0.5s;transition:0.5s;}", ".showOverlay.jsx-1209067736{height:100%;width:100%;position:fixed;z-index:5000;top:0;left:0;overflow-x:hidden;-webkit-transition:0.5s;transition:0.5s;}", ".cancel-highlight.jsx-1209067736{visibility:hidden;}", ".feed-card-item-selected.jsx-1209067736:hover .cancel-highlight.jsx-1209067736{visibility:visible;}", ".feed-card-item.jsx-1209067736{font-size:16px;color:#4d4d4d;padding:6px;position:relative;left:-8px;}", ".feed-card-item-selected.jsx-1209067736{background-color:#fff;width:150px;box-shadow:inset 0 0 0 1px #e6e8eb;border-radius:2px;}", ".showOverlayie.jsx-1209067736{height:100%;width:100%;position:fixed;z-index:5000;top:0;left:0;background-color:rgb(0,0,0);background-color:rgba(0,0,0,0.5);overflow-x:hidden;-webkit-transition:0.5s;transition:0.5s;}", ".section-theme-i-rec.jsx-1209067736{margin-top:0%;}", ".section-theme-i-rec-1.jsx-1209067736{margin-top:25%;}", ".close-popup-icon.jsx-1209067736>span.jsx-1209067736{position:relative;top:-2px;}", ".section-theme.jsx-1209067736{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}", "@media (min-width:768px){.close-popup-iconie.jsx-1209067736{top:0;cursor:pointer;position:absolute;left:66%;height:40px;width:40px;color:rgb(91,56,141);border-radius:50px;background:#e6ecf0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}.close-popup-iconie-irec.jsx-1209067736{top:53.2%;cursor:pointer;position:absolute;left:61.5%;height:40px;width:40px;color:rgb(91,56,141);border-radius:50px;background:#e6ecf0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}}", "@media (min-width:1024px){.new-feed-container.jsx-1209067736{position:relative;float:right;left:-3.6%;top:88px;}}", "@media screen and (min-width:1024px) and (max-width:1280px){.new-feed-container.jsx-1209067736{left:-12px;}}", "@media (max-width:1024px){.new-feed-container.jsx-1209067736{display:none;}}", "@media (max-width:767px){.feed.jsx-1209067736{display:none;}.feed-card.jsx-1209067736{display:none;}}", ".feed-card-filter.jsx-1209067736{font-weight:600;font-size:18px;}", ".feedCardWhenUserisLogged.jsx-1209067736{position:fixed;top:15.4%;left:72.3%;}", ".feedCardWhenUserIsNotLogged.jsx-1209067736{position:relative;left:905px;top:-123px;}", ".feedCard.jsx-1209067736{position:absolute;left:80.03%;}", ".feed.jsx-1209067736{display:block;box-sizing:border-box;position:absolute;left:6.5%;top:55px !important;}", "i.jsx-1209067736{position:relative;padding-right:5px;top:1px;}", "li.jsx-1209067736{list-style-type:none;margin-bottom:10px;padding-right:20px;cursor:pointer;overflow:hidden;box-sizing:border-box;}", "li.jsx-1209067736 .a-feed.jsx-1209067736{font-size:1.2em;font-family:inherit;font-weight:600;text-spacing:0.9px;color:#58647b !important;padding:0px;}", "li.jsx-1209067736 .a-feedie.jsx-1209067736{font-size:1.2em;font-family:inherit;font-weight:600;text-spacing:0.9px;color:rgb(91,56,141) !important;padding:0px;}", ".active.jsx-1209067736{background:#e9ebee;}", ".card-list-item.jsx-1209067736{overflow:hidden;background-color:#fdfdfd;margin-bottom:0px;padding:18px;border:1px solid #e6e8eb;border-radius:5px;}", "h1.jsx-1209067736,h2.jsx-1209067736,h3.jsx-1209067736,h4.jsx-1209067736,h5.jsx-1209067736,h6.jsx-1209067736{font-weight:inherit;line-height:24px;font-size:inherit;color:#0d0d0d;}", ".home-page.jsx-1209067736{height:100vh;font-size:16px;font-weight:400;line-height:24px;-webkit-letter-spacing:0.1px;-moz-letter-spacing:0.1px;-ms-letter-spacing:0.1px;letter-spacing:0.1px;text-transform:none;}", ".home-page-view.jsx-1209067736{max-width:none;min-width:320px;width:auto;margin:0 auto;padding:0;}", ".page-content.jsx-1209067736{max-width:1280px;margin:0 auto;padding-left:36px;padding-right:36px;}", ".page-content.jsx-1209067736:after{content:\"\";display:block;clear:both;-webkit-flex-basis:0;-ms-flex-preferred-size:0;flex-basis:0;-webkit-box-flex:0;-webkit-flex-grow:0;-ms-flex-positive:0;flex-grow:0;-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;}", ".tag-selector-header.jsx-1209067736{position:relative;background-image:linear-gradient(135deg,#2b5876,#4e4376);-webkit-transition:height 0.2s;transition:height 0.2s;min-height:252px;}", ".tag-selector-tag-builder.jsx-1209067736{position:absolute;left:50%;width:100%;-webkit-transform:translateX(-50%);-ms-transform:translateX(-50%);transform:translateX(-50%);display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-align-content:space-between;-ms-flex-line-pack:space-between;align-content:space-between;padding-top:24px;padding-bottom:24px;color:#fff;-webkit-transition:opacity 0.2s;transition:opacity 0.2s;}", ".tag-selector-tag-builder-content.jsx-1209067736{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex:1 0 100%;-ms-flex:1 0 100%;flex:1 0 100%;max-width:100%;}", ".tag-selector-tag-builder-section.jsx-1209067736{-webkit-flex:1 1;-ms-flex:1 1;flex:1 1;max-width:50%;text-align:center;margin:0 36px;}", ".tag-selector-tag-builder-section.jsx-1209067736:first-child{margin-left:0;}", ".tag-selector-tag-builder-label.jsx-1209067736{font-size:18px;font-weight:600;line-height:24px;margin-bottom:12px;}", ".tag-selector-search.jsx-1209067736{position:relative;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;max-width:624px;margin:0 12px;}", ".icon.tag-selector-search-icon.jsx-1209067736{position:absolute;left:0;width:18px;height:18px;color:#b3b3b3;margin:0 12px;font-size:18px;line-height:36px;}", "input[type=\"text\"].tag-selector-search-input.jsx-1209067736{font-size:14px;font-weight:400;line-height:18px;border:1px solid #d9d9d9;outline:none;border-radius:4px;display:block;font-family:inherit;line-height:24px;padding:0 12px;width:100%;margin-top:12px;height:36px;padding-left:42px;margin:0;line-height:36px;border-radius:4px;border:none;}", ".tag-selector-tag-builder-copy.jsx-1209067736{margin-top:18px;}", ".tag-selector-tag-builder-list.jsx-1209067736{margin-top:12px;overflow:hidden;}", ".tag-selector-tag-builder-list.suggested.jsx-1209067736{max-height:108px;}", ".tag-selector-tag.jsx-1209067736{color:inherit;cursor:pointer;-webkit-text-decoration:none;text-decoration:none;-webkit-transition:color 0.15s;transition:color 0.15s;font-size:13px;font-weight:600;text-transform:uppercase;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;height:27px;padding:0 9px;margin:3px;border-radius:15px;box-shadow:inset 0 0 0 1.5px #4d4d4d;color:#4d4d4d;white-space:nowrap;-webkit-transition:background-color 0.15s;transition:background-color 0.15s;height:21px;line-height:21px;margin:0 1.5px 3px;color:#fff;box-shadow:inset 0 0 0 1.5px hsla(0,0%,100%,0.4);}", ".tag-selector-tag-builder-submit.jsx-1209067736{-webkit-flex:1 0 100%;-ms-flex:1 0 100%;flex:1 0 100%;margin-top:24px;text-align:center;}", "button.jsx-1209067736{display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;border:none;line-height:36px;padding:0 18px;background-color:transparent;white-space:nowrap;border-radius:0;}", "button.jsx-1209067736:hover{cursor:pointer;}", ".text-button.jsx-1209067736{color:#fff;min-width:120px;font-size:14px;font-weight:600;text-transform:uppercase;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;}", ".text-button.jsx-1209067736:hover{background-color:transparent;}", ".primary-button.jsx-1209067736{min-width:120px;font-size:14px;font-weight:600;text-transform:uppercase;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;box-shadow:none;border-radius:9px;color:#fff;background-color:#1b9ad1;}", ".nav-header.jsx-1209067736{width:100%;position:relative;overflow:hidden;box-shadow:0 0 0 1px #e6e8eb;line-height:36px;background-color:#fdfdfd;-webkit-transform:translateZ(0);-ms-transform:translateZ(0);transform:translateZ(0);height:36px;}", ".nav-header.scrollable.jsx-1209067736{overflow-x:auto;}", ".show-mobile.jsx-1209067736{display:none;}", ".nav-header-content.jsx-1209067736{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-webkit-justify-content:space-between;-ms-flex-pack:justify;justify-content:space-between;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;}", ".nav-header.scrollable.jsx-1209067736 .nav-header-content.jsx-1209067736{-webkit-flex-wrap:nowrap;-ms-flex-wrap:nowrap;flex-wrap:nowrap;white-space:nowrap;}", ".nav-header-list.jsx-1209067736{-webkit-flex-shrink:1;-ms-flex-negative:1;flex-shrink:1;-webkit-box-flex:1;-webkit-flex-grow:1;-ms-flex-positive:1;flex-grow:1;-webkit-flex-basis:100px;-ms-flex-preferred-size:100px;flex-basis:100px;}", ".nav-header.scrollable.jsx-1209067736 .nav-header-list.jsx-1209067736{-webkit-flex-shrink:0;-ms-flex-negative:0;flex-shrink:0;}", "a.jsx-1209067736{color:#000;cursor:pointer;-webkit-text-decoration:none;text-decoration:none;-webkit-transition:color 0.15s;transition:color 0.15s;}", ".nav-header-item.jsx-1209067736{font-size:11px;font-weight:600;text-transform:uppercase;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;color:#58647b !important;margin-right:13px;vertical-align:top;font-family:Cabin;}", ".nav-header-item.selected.jsx-1209067736{position:relative;color:#1b9ad1;}", ".nav-sidebar.jsx-1209067736{position:relative;width:258px;min-height:24px;padding-top:42px;}", ".nav-sidebar.left.jsx-1209067736{float:left;}", ".nav-sidebar.left.jsx-1209067736 .nav-sidebar-content.jsx-1209067736{padding-right:60px;}", ".nav-sidebar-content.jsx-1209067736{width:258px;}", ".home-page-feed.jsx-1209067736{padding-top:42px;padding-bottom:48px;margin-right:300px;margin-left:258px;padding-right:27px;box-shadow:none;}", ".card-list-answer-skip.jsx-1209067736{font-size:14px;font-weight:600;text-transform:uppercase;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;float:right;height:36px;border-radius:9px;color:#60338d;}", ".card-list-answer-subtitle.jsx-1209067736{line-height:4px;margin:auto;}", ".card-list-answer-title.jsx-1209067736{margin:auto;font-size:18px;font-weight:600;line-height:14px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;min-height:102px;padding:6px 0;text-align:center;}", ".card-list-footer.jsx-1209067736{padding-top:18px;}", ".card-list-footer.center.jsx-1209067736{text-align:center;}", ".FAB.jsx-1209067736{display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;text-align:center;height:48px;color:#fff !important;text-align:center !important;border-radius:5px;vertical-align:top;font-size:10px;-webkit-transition:background-color 0.15s;transition:background-color 0.15s;}", ".FAB.small.jsx-1209067736{height:42px;border-radius:21px;}", "a.jsx-1209067736{color:#000 !important;}", ".rec-card-list.jsx-1209067736{margin-bottom:30px;}", ".rec-card-list-header.jsx-1209067736{font-size:18px;font-weight:600;line-height:27px;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;line-height:48px;color:#4d4d4d;}", "@media (min-width:1023px){.rec-card-list.jsx-1209067736{margin-bottom:30px;position:relative;}}", "@media (max-width:1279px){.home-page-feed.jsx-1209067736{margin-left:204px;margin-right:240px;}}", "@media (max-width:1023px){.tag-selector-header.jsx-1209067736{min-height:270px;}.home-page-feed.jsx-1209067736{padding-right:0;margin-right:auto;box-shadow:none;padding-top:42px;}}", "@media (max-width:767px){.page-content.jsx-1209067736{padding-left:12px;padding-right:12px;}.tag-selector-header.jsx-1209067736{min-height:497px;}.tag-selector-tag-builder-content.jsx-1209067736{-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;}.tag-selector-tag-builder-section.jsx-1209067736{margin:0 0 36px;max-width:none;}.tag-selector-tag-builder-label.jsx-1209067736{line-height:27px;margin-bottom:24px;}.tag-selector-tag-builder-list.jsx-1209067736{margin-top:18px;}.tag-selector-tag-builder-list.jsx-1209067736{max-height:80px;}.tag-selector-tag-builder-submit.jsx-1209067736{margin-top:0;}.show-mobile.jsx-1209067736{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;}.nav-sidebar.jsx-1209067736{display:none;}.home-page-feed.jsx-1209067736{margin-left:auto;padding-top:30px;}.home-page-view.jsx-1209067736{background-color:inherit;}.card-list-item.jsx-1209067736{margin:0 0 30px;padding:12px;}.card-list-answer-title.jsx-1209067736{font-size:21px;line-height:30px;}.card-list-footer.jsx-1209067736{padding-top:12px;}.FAB-label.jsx-1209067736{line-height:42px;margin-left:18px;margin-right:6px;}.rec-card-list-header.jsx-1209067736{font-size:18px;line-height:24px;line-height:36px;margin-top:24px;margin-bottom:24px;padding-left:12px;}}", "@media only screen and (min-width:768px) and (max-width:900px){.feed.jsx-1209067736{left:0;}}", "@media only screen and (min-width:900px) and (max-width:1025px){.feed.jsx-1209067736{left:0px;}}", "@media only screen and (min-width:1025px) and (max-width:1281px){.feed.jsx-1209067736{left:0px;}}"])));
    }
  }]);
...
// CONCATENATED MODULE: ./components/tag/TagLandingPage.js
...
var TagLandingPage_TagLandingPage =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(TagLandingPage, _Component);

  function TagLandingPage() {
    var _getPrototypeOf2;

    var _this;

    Object(classCallCheck["a" /* default */])(this, TagLandingPage);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(possibleConstructorReturn["a" /* default */])(this, (_getPrototypeOf2 = Object(getPrototypeOf["a" /* default */])(TagLandingPage)).call.apply(_getPrototypeOf2, [this].concat(args)));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "state", {
      recs: [],
      follow: false,
      copied: false // url: `${CLIENT_API}/topic/${RemoveSpacesAddHyphen(this.props.question)}`

    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "getTotalRecs", function (question) {
      Object(apiRequests["N" /* GetQuestionTotalRecs */])(question).then(function (result) {
        _this.setState({
          recs: result.data
        });
      }).catch(function (err) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "CheckWhetherQuestionIsFollowed", function (questionId) {
      ...
      if (user) {
        Object(apiRequests["D" /* GetFollowedQuestion */])(questionId, user._id).then(function (result) {
          _this.setState({
            follow: result.data
          });
        }).catch(function (err) {
  ...
  Object(createClass["a" /* default */])(TagLandingPage, [{
    key: "componentDidMount",
    value: function () {
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          tag = _this$props.tag;
      return external_react_default.a.createElement("div", {
        className: "jsx-1693363244" + " " + "landing"
      }, external_react_default.a.createElement("div", {
        className: "jsx-1693363244" + " " + "landing-question"
      }, tag ? tag : "loading..."), external_react_default.a.createElement(style_default.a, {
        id: "1693363244"
      }, [".landing.jsx-1693363244{width:100%;background:#fdfdfd !important;box-sizing:border-box;font-size:15px;font-family:inherit;border:1px solid transparent;}", ".landing-question.jsx-1693363244{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:start;-webkit-justify-content:flex-start;-ms-flex-pack:start;justify-content:flex-start;padding:30px 0px;text-transform:capitalize;font-size:40px;font-weight:700;color:rgb(91,56,141);font-family:Cabin;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;cursor:pointer;}", ".landing-question.jsx-1693363244:hover{color:#4e4376;}", ".landing-details.jsx-1693363244{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-item:center;-webkit-box-align-item:center;-ms-flex-align-item:center;align-item:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;margin-bottom:30px;}", ".details.jsx-1693363244{padding:3px 10px;margin-top:30px;box-sizing:border-box;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;margin-right:8px;}", "@media (min-width:768px){.landing.jsx-1693363244{max-width:100%;background:#fdfdfd !important;margin-top:1px auto;box-sizing:border-box;font-family:inherit;padding:24px 0;border:1px solid #e6e8eb;padding-left:48px;padding-right:48px;}.landing-question.jsx-1693363244{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:start;-webkit-justify-content:flex-start;-ms-flex-pack:start;justify-content:flex-start;position:relative;left:60px;font-size:40px;font-weight:700;font-family:Cabin;}.option-considered.jsx-1693363244{font-size:26px;}.option-considered-text.jsx-1693363244{font-size:0.8em;}}", "@media (max-width:768px){.landing-question.jsx-1693363244{-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;font-size:21px;padding-right:5px;padding-left:5px;position:relative;top:17px;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;}.follow.jsx-1693363244{visibilty:hidden !important;}.landing-details.jsx-1693363244 .details.jsx-1693363244{padding:3px 9px;margin-top:30px;color:#637381;font-size:3.2vw;font-weight:600;text-transform:uppercase;}.option-considered.jsx-1693363244{font-size:12px;}.option-considered-text.jsx-1693363244{font-size:0.9em;}.tagged.jsx-1693363244{font-size:11px;color:#2b5876;white-space:nowrap;}}"]));
    }
  }]);
...
/* harmony default export */ var tag_TagLandingPage = (TagLandingPage_TagLandingPage);
// CONCATENATED MODULE: ./components/tag/otherTags.js




var otherTags_OtherTags = function OtherTags(_ref) {
  var otherTags = _ref.otherTags;
  return external_react_default.a.createElement("div", {
    className: "jsx-164579878" + " " + "landing"
  }, external_react_default.a.createElement("div", {
    className: "jsx-164579878" + " " + "landing-question"
  }, external_react_default.a.createElement("div", {
    className: "jsx-164579878" + " " + "popular-tag"
  }, "Other Popular Tags:"), otherTags.slice(0, 5).map(function (item, index) {
    return external_react_default.a.createElement("div", {
      key: index,
      className: "jsx-164579878" + " " + "tag"
    }, external_react_default.a.createElement(link_default.a, {
      prefetch: true,
      as: "/tags/".concat(item),
      href: "/tags/".concat(item)
    }, external_react_default.a.createElement("span", {
      className: "jsx-164579878"
    }, item)));
  })), external_react_default.a.createElement(style_default.a, {
    id: "164579878"
  }, [".landing.jsx-164579878{width:100%;background:#fdfdfd !important;box-sizing:border-box;font-size:15px;font-family:inherit;border:1px solid transparent;}", ".popular-tag.jsx-164579878{margin-left:5px;font-size:12px;color:#58647b;}", ".landing-question.jsx-164579878{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-box-pack:start;-webkit-justify-content:flex-start;-ms-flex-pack:start;justify-content:flex-start;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;padding:10px 0px;text-transform:capitalize;font-size:16px;font-weight:700;color:rgb(91,56,141);font-family:Cabin;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;cursor:pointer;}", ".tag.jsx-164579878{margin-left:10px;text-transform:uppercase;font-size:10px;font-weight:400;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;}", ".landing-question.jsx-164579878:hover{color:#4e4376;}", "@media (min-width:1023px){.popular-tag.jsx-164579878{margin-left:108px;margin-right:50px;font-size:16px;color:#58647b;}.tag.jsx-164579878{margin-left:10px;text-transform:uppercase;font-size:16px;font-weight:400;-webkit-letter-spacing:0.4px;-moz-letter-spacing:0.4px;-ms-letter-spacing:0.4px;letter-spacing:0.4px;}}"]));
};

/* harmony default export */ var tag_otherTags = (otherTags_OtherTags);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return tag_default; });
  ...
  Object(createClass["a" /* default */])(_default, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(Layout["a" /* default */], Object(esm_extends["a" /* default */])({
        ...
        indexPage: true
      }, this.state), external_react_default.a.createElement(tag_TagLandingPage, Object(esm_extends["a" /* default */])({}, this.state, {
        tag: this.props.tagie
      })), external_react_default.a.createElement(tag_otherTags, {
        ...
        otherTags: this.props.otherTags,
        tag: this.props.tagResponse,
        tagie: this.props.tagie,
    ...
    value: function () {
      ...
      regenerator_default.a.mark(function _callee(_ref) {
        var tagie, tagResponse, otherTagResponse, response, recResponse, questionActivityResponse;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                tagie = _ref.query.tagie;
                _context.next = 3;
                return Object(apiRequests["T" /* GetTopicsByTag */])(tagie);

              case 3:
                tagResponse = _context.sent;
                _context.next = 6;
                return Object(apiRequests["J" /* GetOtherTags */])(tagie);

              case 6:
                otherTagResponse = _context.sent;
                _context.next = 9;
              ...
              case 9:
                ...
                _context.next = 12;
                return external_axios_default()(apiRequests["lb" /* _GET_RECS */]);

              case 12:
                recResponse = _context.sent;
                _context.next = 15;
                return external_axios_default()(apiRequests["kb" /* _GET_QUESTION_ACTIVITY */]);
              ...
              case 15:
                ...
                return _context.abrupt("return", {
                  ...
                  tagResponse: tagResponse.data,
                  tagie: tagie,
                  otherTags: otherTagResponse.data
                });
...
module.exports = __webpack_require__("61fb");
...
function (_Component) {
  ...
  function TopicViewPopupModal() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(_this), "handleSubmit", function () {
      ...
      Object(_apiRequests_apiRequests__WEBPACK_IMPORTED_MODULE_10__[/* user_recommendation */ "tb"])(_data).then(function (result) {
