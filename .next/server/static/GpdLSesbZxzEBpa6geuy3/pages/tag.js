...
function (_Component) {
  ...
  function HomePage() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "RemoveFilterTag", function (tag) {
      Object(apiRequests["V" /* GetTopicsByTag */])(tag).then(function (result) {
        _this.setState({
          tags: result.data
        });
      }).catch(function (error) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return Object(apiRequests["V" /* GetTopicsByTag */])(tagie);

              case 3:
                tagResponse = _context.sent;
                _context.next = 6;
                return Object(apiRequests["L" /* GetOtherTags */])(tagie);
