...
function (_Component) {
  ...
  function ProfilePageHeader() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleUpdateProfileSubmit", function (e) {
      ...
      Object(apiRequests["ub" /* updateUser */])(_id, email, displayName, userName).then(function (result) {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleUpdateImage", function (e) {
      ...
      var complete = function complete() {
        storage.ref("images").child(file.name).getDownloadURL().then(function (url) {
          // console.log(url);
          Object(apiRequests["pb" /* addAvatar */])(url, _id).then(function (response) {
...
function (_Component2) {
  ...
  function _default() {
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this3), "getQuestionsAddedByUser", function (id) {
      Object(apiRequests["S" /* GetQuestionsAddedByUser */])(id).then(function (response) {
        _this3.setState({
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this3), "getUserRecHistory", function (id) {
      Object(apiRequests["T" /* GetRecHistory */])(id).then(function (result) {
        _this3.setState({
